...
use super::{
    parse_as_literal, parse_literal, read_until_token_found, recover_until_token_found, skip,
    unexpected_token_error, ArrayTypeInfo, BaseTypeInfo, Generics, GetTokenKind, Span, TokenCursor,
    TupleTypeInfo, TypeAttribute, TypeAttributeEnum, TypeInfo, TypeInfoResult, TypeTag,
    TypeTagKind, TypeTagKindEnum,
};

pub fn parse_type_tag<'input, 'allocator>(
    ...
    let tag_kind = TypeTagKind::new(
        type_tag_kind_enum,
        type_tag_kind_token.unwrap().span.clone(),
    );
...
pub fn parse_type_info<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
...
pub fn parse_base_type_info<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
...
pub fn parse_array_type_info<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
...
pub fn parse_tuple_type_info<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
...
pub fn parse_type_info_result<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
) -> TypeInfoResult<'input, 'allocator> {
    return parse_type_info(cursor)
        .ok_or_else(|| unexpected_token_error(cursor.allocator, cursor.current()));
}

fn parse_type_attributes<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
) -> Vec<TypeAttribute<'input, 'allocator>, &'allocator Bump> {
...
pub fn parse_generics<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
) -> Option<Generics<'input, 'allocator>> {
    let span = Span::start(cursor);
