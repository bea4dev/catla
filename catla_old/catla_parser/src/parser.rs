...
pub type ErrorTokens<'input, 'allocator> =
    Vec<Vec<Token<'input>, &'allocator Bump>, &'allocator Bump>;
...
pub type Statement<'input, 'allocator> =
    ParseResult<'allocator, 'input, StatementAST<'input, 'allocator>>;
...
pub struct FunctionDefine<'input, 'allocator> {
    ...
    pub block_or_semicolon:
        Recovered<'allocator, 'input, Either<Range<usize>, Block<'input, 'allocator>>>,
    pub span: Range<usize>,
}
...
pub type FunctionArgumentResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, FunctionArgument<'input, 'allocator>>;
...
pub type BlockResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Block<'input, 'allocator>>;
pub type BlockRecovered<'input, 'allocator> =
    Recovered<'allocator, 'input, Block<'input, 'allocator>>;
...
pub struct VariableBinding<'input, 'allocator> {
    pub binding:
        Either<Literal<'input>, Vec<VariableBinding<'input, 'allocator>, &'allocator Bump>>,
    pub error_tokens: Vec<Vec<Token<'input>, &'allocator Bump>, &'allocator Bump>,
    pub span: Range<usize>,
}

pub type VariableBindingResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, VariableBinding<'input, 'allocator>>;
...
pub type ExpressionResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Expression<'input, 'allocator>>;
...
pub struct OrExpression<'input, 'allocator> {
    ...
    pub right_exprs:
        Vec<(OrOperatorSpan, AndExpressionResult<'input, 'allocator>), &'allocator Bump>,
    pub span: Range<usize>,
}
...
pub struct AndExpression<'input, 'allocator> {
    ...
    pub right_exprs:
        Vec<(AndOperatorSpan, CompareExpressionResult<'input, 'allocator>), &'allocator Bump>,
    pub span: Range<usize>,
}

pub type AndOperatorSpan = Range<usize>;
pub type AndExpressionResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, AndExpression<'input, 'allocator>>;

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct CompareExpression<'input, 'allocator> {
    pub left_expr: AddOrSubExpression<'input, 'allocator>,
    pub right_exprs:
        Vec<(CompareOp, AddOrSubExpressionResult<'input, 'allocator>), &'allocator Bump>,
    pub span: Range<usize>,
}

pub type CompareOp = Spanned<CompareOpKind>;
pub type CompareExpressionResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, CompareExpression<'input, 'allocator>>;
...
pub struct AddOrSubExpression<'input, 'allocator> {
    ...
    pub right_exprs:
        Vec<(AddOrSubOp, MulOrDivExpressionResult<'input, 'allocator>), &'allocator Bump>,
    pub span: Range<usize>,
}

pub type AddOrSubOp = Spanned<AddOrSubOpKind>;
pub type AddOrSubExpressionResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, AddOrSubExpression<'input, 'allocator>>;
...
pub type MulOrDivExpressionResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, MulOrDivExpression<'input, 'allocator>>;
...
pub type FactorResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Factor<'input, 'allocator>>;
...
pub type PrimaryResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Primary<'input, 'allocator>>;
...
pub enum PrimaryLeftExpr<'input, 'allocator> {
    Simple(
        (
            SimplePrimary<'input, 'allocator>,
            Option<GenericsResult<'input, 'allocator>>,
...
pub type FunctionCallResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, FunctionCall<'input, 'allocator>>;
pub type CallArgumentsResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Vec<Expression<'input, 'allocator>, &'allocator Bump>>;
...
pub type FieldAssignsResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Vec<FieldAssign<'input, 'allocator>, &'allocator Bump>>;
...
pub struct ElseIfOrElse<'input, 'allocator> {
    ...
    pub else_if_or_else: Recovered<
        'allocator,
        'input,
        Either<IfStatement<'input, 'allocator>, Block<'input, 'allocator>>,
    >,
    pub span: Range<usize>,
}
...
pub struct Closure<'input, 'allocator> {
    ...
    pub expression_or_block: Recovered<
        'allocator,
        'input,
        Either<Expression<'input, 'allocator>, Block<'input, 'allocator>>,
    >,
    pub span: Range<usize>,
}
...
pub struct ClosureArguments<'input, 'allocator> {
    pub arguments: Either<
        Literal<'input>,
        Vec<Either<FunctionArgument<'input, 'allocator>, Literal<'input>>, &'allocator Bump>,
    >,
    pub error_tokens: Vec<Token<'input>, &'allocator Bump>,
...
pub type TypeInfoResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, TypeInfo<'input, 'allocator>>;
...
pub type GenericsResult<'input, 'allocator> =
    ParseResult<'allocator, 'input, Generics<'input, 'allocator>>;
...
impl Span {
    ...
    pub fn elapsed<'input, 'allocator>(
        &self,
...
fn parse_program<'input, 'allocator>(
    ...
    return cursor.allocator.alloc(ProgramAST {
        statements,
        not_separated_stmts,
...
fn skip<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
    skip_kinds: &[TokenKind],
) -> usize {
...
fn parse_as_literal<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
) -> Option<Literal<'input>> {
    return match cursor.next() {
...
fn parse_literal_result<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
) -> LiteralResult<'input, 'allocator> {
...
fn read_until_token_found<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
    until: &[TokenKind],
) -> Vec<Token<'input>, &'allocator Bump> {
...
fn recover_until_token_found<'input, 'allocator>(
    cursor: &mut TokenCursor<'input, 'allocator>,
    until: &[TokenKind],
) -> Vec<Token<'input>, &'allocator Bump> {
...
fn unexpected_token_error<'input, 'allocator>(
    allocator: &'allocator Bump,
    token: Option<&Token<'input>>,
) -> ASTParseError<'input, 'allocator> {
    return match token {
        Some(next) => ASTParseError::UnexpectedToken(vec![in allocator; next.clone(); 1]),
